  ...
  <div class="status-overview h-100 bg-dark text-light d-flex p-3">
    ...
    <div class="text-start py-3 px-1">
      ...
      <div class="status-card sub_status">
        ...
        <div
          class="status-text"
          v-bind:class=" AGVStatesData.SubState.toLowerCase()"
        >{{ AGVStatesData.SubState }}</div>
      </div>
      ...
      <div class="status-card-info">
        <div class>
          ...
          <div
            class="item-val"
          >{{ AGVStatesData.Last_Visit_MapPoint.Name +'('+AGVStatesData.Last_Visited_Tag +')' }}</div>
        </div>
      </div>
      <div class="status-card-info">
        <div class>
          ...
          <div
            class="item-val"
            v-bind:style="{color:LocStatusDisplay()=='System-Error'?'red':'white'}"
          >{{ LocStatusDisplay() }}</div>
        </div>
      </div>
      <div class="status-card-info">
        <div class>
      ...
      <div class="status-card-info">
        <div class>
          ...
          <div class="item-val">
            {{AGVStatesData.Mileage.toFixed(2) }}
            <span>km</span>
          </div>
        </div>
      </div>
    ...
    <div class="text-start" style="padding-top:62px;">
      ...
      <div class="status-card-info">
        <div class>
          ...
          <div
            class="item-val"
          >( {{AGVStatesData.Pose.position.x.toFixed(2) }}, {{AGVStatesData.Pose.position.y.toFixed(2) }})</div>
        </div>
      </div>
      <div class="status-card-info">
        <div class>
